...
<section class="violet">
	...
	<form id="loginForm" name="loginForm" method="post" action="NEWdpd_form.php">
		<p>Log In with Email Address (preferably DMACC email): <input type="text" id="emailLogin" name="emailLogin" /> <span id="loginEmailError"></span> <input type="button" name="submitLogin" value="Log In" onclick="validateLoginEmail();" /></p>
